...
// Output JavaScript code with the value of $isManager
echo "<script>var isManager = " . ($isManager ? 'true' : 'false') . ";</script>";
?>
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4" style="max-height: 500px; overflow-y: auto;">
                            <h3 class="h3 mb-4 text-gray-800">Employee Timesheets</h3>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>Date</th>
                                ...
                                <tbody id="timesheetBody">
                                    <?php
                                    $manager_id = $_SESSION['user_id']; // Assuming user_id is the unique identifier for managers
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>";
                                        echo "<button onclick='approveTimesheet({$row['timesheet_id']})'>Approve</button>";
                                        echo "<button onclick='rejectTimesheet({$row['timesheet_id']})'>Reject</button>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    ?>
    ...
    <!-- Include your custom scripts after including jQuery -->
